  ...
  return [
    ...
    tbl(
      ...
      [
        ...
        ['Save load test results to file',           'k6 run tests/k6/load-test.js 2>&1 | Tee-Object -FilePath results.txt', '5 min'],
      ]
    ),
    gap(),
    h3('k6 Location'),
...
function excelSec(): Paragraph[] {
  return [
    ...
    body('The Excel workbook at tests/test-cases/Suraksha_Test_Cases.xlsx contains all 100 test cases with actual execution results.'),
    gap(),
    h2('4.1 File Location'),
    code('D:\\Suraksha - Web App\\tests\\test-cases\\Suraksha_Test_Cases.xlsx'),
    gap(),
...
function loadTests(): Paragraph[] {
  return [
    ...
    body('Run command:'),
    code('cd "D:\\Suraksha - Web App\\backend"'),
    code('D:\\k6\\k6-v0.54.0-windows-amd64\\k6.exe run tests/k6/load-test.js'),
    gap(),
    ...
    gap(),
    code('D:\\k6\\k6-v0.54.0-windows-amd64\\k6.exe run tests/k6/spike-test.js'),
    gap(),
    body('Actual result:'),
    tbl(['Metric', 'Result', 'Status'], [
    ...
    gap(),
    code('D:\\k6\\k6-v0.54.0-windows-amd64\\k6.exe run tests/k6/stress-test.js'),
    gap(),
    ...
    gap(),
    code('D:\\k6\\k6-v0.54.0-windows-amd64\\k6.exe run tests/k6/soak-test.js'),
    gap(),
    h2('6.6 Save Load Test Results to a File'),
    code('D:\\k6\\k6-v0.54.0-windows-amd64\\k6.exe run tests/k6/load-test.js 2>&1 | Tee-Object -FilePath load-test-results.txt'),
...
function vivaSec(): Paragraph[] {
  return [
    ...
    bullet('Open D:\\Suraksha - Web App\\tests\\test-cases\\Suraksha_Test_Cases.xlsx'),
    ...
    bullet('Open tests/k6/ — show the 4 test script files'),
...
function fileRef(): Paragraph[] {
  return [
    ...
    tbl(['File / Folder', 'Path', 'Purpose'], [
      ['Excel Test Cases',         'tests/test-cases/Suraksha_Test_Cases.xlsx',         '100 test cases with results'],
      ...
      ['Load Test script',         'tests/k6/load-test.js',           'k6 — 100 VUs, 5 minutes'],
      ['Stress Test script',       'tests/k6/stress-test.js',          'k6 — ramp to 200 VUs'],
      ['Spike Test script',        'tests/k6/spike-test.js',           'k6 — 300 VU burst'],
      ['Soak Test script',         'tests/k6/soak-test.js',            'k6 — 50 VUs, 30 minutes'],

    ...
    <>
      ...
      <div className="space-y-8 animate-in fade-in duration-500 font-sans pb-20 w-full min-w-0">
        <div className="flex items-center justify-between">
          ...
          >
            <div className="bg-white dark:bg-gray-900/20 p-1.5 rounded-lg group-hover:bg-white dark:bg-gray-900/30 transition-colors">
        ...
        {/* Filters */}
        <div className="suraksha-card p-6 flex flex-wrap gap-4 items-center bg-white dark:bg-gray-900/80 backdrop-blur-sm">
          <div className="flex gap-4">
            <div className="relative group">
              <select
                value={severityFilter}
                onChange={(e) => setSeverityFilter(e.target.value)}
                className="bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-800 rounded-xl px-5 py-3 text-[11px] font-black appearance-none focus:outline-none focus:ring-2 focus:ring-[#0061ff]/10 cursor-pointer min-w-[150px] text-gray-800 dark:text-white/90 uppercase tracking-widest"
              >
                {severities.map(s => <option key={s} value={s}>{s}</option>)}
              </select>
              <LucideChevronDown className="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 dark:text-gray-500 pointer-events-none" />
            </div>
            <div className="relative group">
              <select
                value={statusFilter}
            ...
            {user?.role === 'CITIZEN' && (
              <button
                ...
                className={cn(
                  ...
                  showOnlyMine ? "bg-blue-600 text-white border-blue-600" : "bg-white dark:bg-gray-900 text-gray-400 dark:text-gray-500 border-gray-200 dark:border-gray-800 hover:bg-gray-50 dark:bg-gray-800/50"
                )}
              >
        ...
        <div className="suraksha-card overflow-hidden shadow-2xl shadow-blue-500/5">
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-gray-50 dark:bg-gray-800/50/50 border-b border-gray-200 dark:border-gray-800/50">
                  <th className="px-4 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 dark:text-gray-500">{t('incidents.tracker_id')}</th>
                  <th className="px-4 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 dark:text-gray-500">{t('incidents.details')}</th>
                  <th className="px-4 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 dark:text-gray-500 text-center">{t('incidents.priority')}</th>
                  <th className="px-4 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 dark:text-gray-500 text-center">{t('incidents.review_status')}</th>
                  <th className="px-4 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 dark:text-gray-500 text-center">Type</th>
                  <th className="px-4 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 dark:text-gray-500 text-center">{t('incidents.age')}</th>
                  <th className="px-4 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 dark:text-gray-500 text-right">{t('incidents.operations')}</th>
                </tr>
              </thead>
                  ...
                  <tr>
                    <td colSpan={7} className="px-8 py-20 text-center">
                      <div className="flex flex-col items-center gap-3">
                        ...
                        <span className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">{t('incidents.syncing')}</span>
                      </div>
                    </td>
                  </tr>
                ) : filteredIncidents.length === 0 ? (
                  <tr>
                    <td colSpan={7} className="px-8 py-20 text-center text-gray-400 dark:text-gray-500 uppercase tracking-widest text-[11px] font-black italic">
                  ...
                  filteredIncidents.map((incident) => {
                    ...
                    return (
                      <tr key={incident.id} className={cn("hover:bg-blue-50/[0.15] transition-all group border-l-4", isSlaBreached ? "bg-red-50/30 border-l-red-500" : "border-l-transparent hover:border-l-[#0061ff]")}>
                        <td className="px-4 py-6 text-[11px] text-gray-400 dark:text-gray-500 uppercase tracking-widest font-black">
                        ...
                        <td className="px-4 py-6">
                          <div className="text-base text-gray-800 dark:text-white/90 font-black group-hover:text-brand-500 transition-colors flex items-center gap-2">
                            {incident.title}
                            {incident.severity === 'CRITICAL' && <div className="w-2 h-2 rounded-full bg-red-500 animate-pulse" />}
                          </div>
                          <div className="text-[12px] text-gray-400 dark:text-gray-500 mt-1 font-bold flex items-center gap-1.5 leading-none">
                            <MapPin className="w-3 h-3 text-slate-300" />
                            {incident.location}
                          </div>
                        </td>
                        <td className="px-4 py-6 text-center text-sm font-bold text-gray-500 dark:text-gray-400">
                          <span className={cn(
                        ...
                        <td className="px-4 py-6 text-center text-[10px] font-black text-gray-400 dark:text-gray-500 whitespace-nowrap uppercase tracking-widest">
                        ...
                        <td className="px-4 py-6 text-right">
                          <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-all">
                            ...
                            <button
                              ...
                              className="w-10 h-10 rounded-xl bg-gray-50 dark:bg-gray-800/50 flex items-center justify-center text-gray-400 dark:text-gray-500 hover:bg-white dark:bg-gray-900 hover:text-brand-500 hover:shadow-xl hover:shadow-blue-500/10 transition-all border border-transparent hover:border-gray-200 dark:border-gray-800"
                            >
        ...
        {mergeCandidate && (
          <div className="fixed inset-0 z-[999999] flex items-center justify-center p-4 animate-in fade-in zoom-in duration-200">
            ...
            <div className="relative w-full max-w-md bg-white dark:bg-gray-900 rounded-[2.5rem] shadow-2xl overflow-hidden p-8 border border-white">
              <div className="flex items-center gap-4 border-b border-gray-200 dark:border-gray-800 pb-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest mt-1">Duplicate Detected within 500m</p>
                </div>
              </div>
              <div className="space-y-4 mb-8">
                <div className="p-4 bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-gray-200 dark:border-gray-800">
                  <div className="text-[9px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-1">Source (Will be deleted)</div>
              ...
              <div className="flex gap-4">
                <button onClick={() => setMergeCandidate(null)} className="flex-1 px-6 py-4 rounded-2xl bg-gray-50 dark:bg-gray-800/50 text-gray-600 dark:text-gray-300 font-bold text-xs uppercase tracking-widest hover:bg-gray-100 dark:bg-gray-800 transition-colors">Cancel</button>
        ...
        {incidentToDelete && (
          <div className="fixed inset-0 z-[999999] flex items-center justify-center p-4 animate-in fade-in zoom-in duration-200">
            ...
            <div className="relative w-full max-w-sm bg-white dark:bg-gray-900 rounded-[2.5rem] shadow-2xl overflow-hidden p-8 text-center border border-white">
              <div className="w-16 h-16 bg-red-50 rounded-full flex items-center justify-center mx-auto mb-6">
                <Trash2 className="w-8 h-8 text-red-500" />
              </div>
              <h3 className="text-2xl font-black text-slate-800 mb-2">Delete Report?</h3>
              <p className="text-sm font-bold text-gray-500 dark:text-gray-400 mb-8 px-2">
                This action cannot be undone. This incident report will be permanently removed from the system.
              </p>
              <div className="flex gap-4">
                <button onClick={() => setIncidentToDelete(null)} className="flex-1 px-6 py-4 rounded-2xl bg-gray-50 dark:bg-gray-800/50 text-gray-600 dark:text-gray-300 font-bold text-xs uppercase tracking-widest hover:bg-gray-100 dark:bg-gray-800 transition-colors">Cancel</button>
...
function CreateIncidentModal({ onClose, onSuccess }: any) {
  ...
  return (
    <div className="fixed inset-0 z-[999999] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-md animate-in fade-in duration-300">
      <div className="suraksha-card w-full max-w-xl max-h-[90vh] overflow-y-auto custom-scrollbar bg-white dark:bg-gray-900 p-8 sm:p-10 space-y-6 sm:space-y-8 animate-in slide-in-from-bottom-8 duration-500 shadow-2xl">
        <div className="flex items-center justify-between border-b border-slate-50 pb-6 shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-2xl font-black text-gray-800 dark:text-white/90">{t('incidents.modals.new_directive')}</h2>
              <p className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mt-0.5 italic">Emergency Resource Protocol #SR-99</p>
            </div>
          </div>
          <button onClick={onClose} className="p-2.5 hover:bg-gray-50 dark:bg-gray-800/50 rounded-xl transition-colors text-slate-300 hover:text-gray-600 dark:text-gray-300">
            <X className="w-6 h-6" />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-2 gap-x-6 gap-y-5">
            <div className="col-span-2 space-y-1.5">
              <label className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest pl-1 italic">{t('incidents.modals.directive_title')}</label>
            ...
            <div className="col-span-2 space-y-1.5">
              <label className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest pl-1 italic">{t('incidents.modals.category')}</label>
            ...
            <div className="col-span-2 space-y-1.5">
              <label className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest pl-1 italic">{t('incidents.modals.briefing')}</label>
...
function IncidentDetailsModal({ incident, onClose }: any) {
  ...
  return (
    <div className="fixed inset-0 z-[999999] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-md animate-in fade-in duration-300">
      <div className="suraksha-card w-full max-w-5xl bg-white dark:bg-gray-900 p-0 overflow-hidden animate-in zoom-in-95 duration-500 shadow-2xl rounded-[3rem]">
        <div className="grid grid-cols-1 md:grid-cols-2 h-full min-h-[600px] max-h-[90vh]">
          ...
          <div className="p-8 md:p-10 space-y-8 flex flex-col overflow-y-auto">
            <div className="flex items-center justify-between">
              ...
              <button onClick={onClose} className="p-2 hover:bg-gray-50 dark:bg-gray-800/50 rounded-xl md:hidden"><X className="w-6 h-6" /></button>
            </div>

            <div className="space-y-4">
              <h2 className="text-3xl font-black text-gray-800 dark:text-white/90 leading-[1.1]">{incident.title}</h2>
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="space-y-1">
                ...
                <div className="font-black text-gray-800 dark:text-white/90 text-lg uppercase">{incident.status}</div>
              </div>
            </div>
            ...
            {incident.status === 'PENDING' && (
              <div className="bg-indigo-50 border border-indigo-100 rounded-3xl p-6">
                ...
                <div className="flex gap-2">
                  ...
                  <button className="px-4 bg-white dark:bg-gray-900 text-indigo-600 text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-indigo-50 transition-colors border border-indigo-200">Modify</button>
                </div>
              </div>
            )}

            <div className="space-y-3 flex-1">
              <div className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest italic">{t('incidents.modals.briefing')}</div>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed font-bold text-sm bg-gray-50 dark:bg-gray-800/50 p-6 rounded-3xl border border-dashed border-gray-200 dark:border-gray-700">
          ...
          <div className="relative bg-gray-50 dark:bg-gray-800/50 border-l border-gray-200 dark:border-gray-800 p-8 md:p-10 flex flex-col overflow-y-auto">
            <button onClick={onClose} className="absolute top-8 right-8 p-3 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-sm hover:bg-gray-50 dark:bg-gray-800/50 transition-all text-gray-400 dark:text-gray-500 hidden md:block z-10"><X className="w-5 h-5" /></button>
              ...
              <div className="relative pl-6 space-y-6 before:absolute before:inset-y-0 before:left-[11px] before:w-0.5 before:bg-gray-200 dark:bg-gray-700">
                {history.map((item, i) => (
                  <div key={i} className="relative">
                    ...
                    <div className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">{format(item.time, 'MMM d, HH:mm')} - {item.user}</div>
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-3xl p-8 text-center hover:bg-white dark:bg-gray-900 transition-colors cursor-pointer group">
                ...
                <div className="text-xs font-black text-gray-600 dark:text-gray-300 uppercase tracking-widest mb-1">Drag & Drop Photos</div>
                <div className="text-[10px] font-bold text-gray-400 dark:text-gray-500">AI will auto-tag uploaded evidence</div>
              </div>
...
function AnalyticsDrillDownModal({ category, onClose }: { category: string, onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[999999] flex items-center justify-center p-4 animate-in fade-in zoom-in duration-200">
      ...
      <div className="relative w-full max-w-3xl bg-white dark:bg-gray-900 rounded-[2.5rem] shadow-2xl p-8 border border-white">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h2 className="text-2xl font-black text-slate-800 flex items-center gap-3">
              <Activity className="w-6 h-6 text-indigo-500" /> {category} Analytics
            </h2>
            <p className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest mt-1">Historical Frequency & Resource Drill-Down</p>
          </div>
          <button onClick={onClose} className="p-2 hover:bg-gray-50 dark:bg-gray-800/50 rounded-xl transition-colors text-gray-400 dark:text-gray-500"><X className="w-6 h-6" /></button>
        </div>

        <div className="grid grid-cols-3 gap-4 mb-8">
          <div className="bg-gray-50 dark:bg-gray-800/50 p-5 rounded-3xl border border-gray-200 dark:border-gray-800">
            <div className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-1">Avg Resolution Time</div>
            <div className="text-2xl font-black text-slate-800">4.2 <span className="text-sm text-gray-500 dark:text-gray-400">hrs</span></div>
          </div>
          <div className="bg-gray-50 dark:bg-gray-800/50 p-5 rounded-3xl border border-gray-200 dark:border-gray-800">
            <div className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-1">Common Resource</div>
            <div className="text-lg font-black text-indigo-600 mt-1">Rescue Boats</div>
          </div>
          <div className="bg-gray-50 dark:bg-gray-800/50 p-5 rounded-3xl border border-gray-200 dark:border-gray-800">
            <div className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-1">Total This Month</div>
            <div className="text-2xl font-black text-slate-800">142</div>
          </div>
        </div>

        <div>
          <h3 className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-4 ml-1">7-Day Incident Frequency</h3>

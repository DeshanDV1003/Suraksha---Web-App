...
export default function DamageAssessmentPage() {
  ...
  const getLevelColor = (level: string) => {
    switch (level) {
      ...
      default: return 'text-gray-400 dark:text-gray-500 bg-gray-50 dark:bg-gray-800/50'
    }
  }
  ...
  return (
        <>
          ...
          <PageBreadcrumb pageTitle="Damage Assessment" />
        ...
        <div className="flex gap-2 bg-white dark:bg-gray-900 p-2 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800">
          <button
            ...
            className={cn(
              ...
              activeTab === 'verification' ? "bg-blue-600 text-white shadow-md" : "text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:bg-gray-800/50"
            )}
          >
          ...
          <button
            ...
            className={cn(
              "flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-sm transition-all",
              activeTab === 'reports' ? "bg-blue-600 text-white shadow-md" : "text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:bg-gray-800/50"
            )}
          >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-6">
              {loading ? (
                ...
                <div className="bg-white dark:bg-gray-900 border border-dashed border-gray-200 dark:border-gray-700 rounded-[2.5rem] p-20 text-center space-y-4">
                  <Home className="w-16 h-16 text-slate-200 mx-auto" />
                  <h3 className="text-xl font-bold text-slate-700">No Assessments Yet</h3>
                  <p className="text-gray-400 dark:text-gray-500 max-w-xs mx-auto">New damage reports from the mobile app will sync here.</p>
                </div>
              ) : (
                <div className="grid grid-cols-1 gap-6">
                  {assessments.map((item) => (
                    <div key={item.id} className="group bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-[2.5rem] p-8 hover:shadow-2xl hover:shadow-blue-500/5 transition-all">
                      <div className="flex flex-col md:flex-row gap-8">
                        <div className="flex-1 space-y-4">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 bg-gray-50 dark:bg-gray-800/50 p-4 rounded-2xl">
                                <div className="space-y-1">
                                  <div className="text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest">Damage</div>
                                ...
                                <div className="space-y-1">
                                  <div className="text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest">Est. Loss</div>
                                ...
                                <div className="space-y-1 col-span-2 text-right">
                                  <div className="text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest">Compensation Eligibility</div>
                            ...
                            {item.status !== 'APPROVED' && item.status !== 'REJECTED' && (
                              <div className="pt-4 border-t border-slate-50 flex gap-2">
                                ...
                                <button onClick={() => updateWorkflow(item.id, 'REJECTED')} className="flex-1 bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 hover:text-red-600 text-xs font-bold py-3 rounded-xl hover:bg-red-50 transition-colors">
            ...
            <div className="space-y-6">
               <div className="bg-slate-900 rounded-[2.5rem] p-8 text-white space-y-6 shadow-2xl">
                  <div className="w-12 h-12 bg-white dark:bg-gray-900/10 rounded-2xl flex items-center justify-center backdrop-blur-md">
                     <ShieldCheck className="w-6 h-6 text-blue-400" />
                  </div>
                  <h3 className="text-2xl font-black">Verification Queue</h3>
                  <div className="space-y-4">
                     <div className="bg-white dark:bg-gray-900/5 rounded-2xl p-4 flex justify-between items-center">
                        <span className="text-gray-400 dark:text-gray-500 text-sm font-bold uppercase tracking-widest">Pending Review</span>
                        <span className="text-xl font-black text-orange-400">{assessments.filter(a => a.status === 'PENDING_REVIEW').length}</span>
                     </div>
                     <div className="bg-white dark:bg-gray-900/5 rounded-2xl p-4 flex justify-between items-center">
                        <span className="text-gray-400 dark:text-gray-500 text-sm font-bold uppercase tracking-widest">Senior Review</span>
          ...
          <div className="bg-white dark:bg-gray-900 p-8 rounded-[2.5rem] border border-gray-200 dark:border-gray-800 shadow-sm">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {reports.map((report, i) => (
                <div key={i} className="bg-gray-50 dark:bg-gray-800/50 p-6 rounded-3xl border border-gray-200 dark:border-gray-800">
                  <div className="flex justify-between items-start mb-6">
                    <div>
                      <h3 className="text-xl font-black text-slate-800">{report.name}</h3>
                      <p className="text-xs text-gray-500 dark:text-gray-400 font-bold uppercase tracking-widest">{report.totalStructures} Structures Assessed</p>
                    </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between bg-white dark:bg-gray-900 p-3 rounded-xl border border-gray-200 dark:border-gray-800 text-sm font-bold">
                      <span className="text-gray-500 dark:text-gray-400">Estimated Total Loss</span>
                      <span className="text-red-600">LKR {report.totalEstimatedLoss.toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between bg-white dark:bg-gray-900 p-3 rounded-xl border border-gray-200 dark:border-gray-800 text-sm font-bold">
                      <span className="text-gray-500 dark:text-gray-400">Affected Persons</span>
                      <span className="text-slate-800">{report.affectedPersons}</span>
                    </div>
                  </div>
                </div>
              ))}
              {reports.length === 0 && <p className="text-gray-400 dark:text-gray-500 font-medium">No active district reports found.</p>}
            </div>
          </div>
        )}
        ...
        {showModal && (
          <div className="fixed inset-0 z-[100] flex justify-center overflow-y-auto bg-slate-900/60 backdrop-blur-md p-4 py-8 sm:py-20 animate-in fade-in duration-300">
            <div className="bg-white dark:bg-gray-900 w-full max-w-4xl rounded-[3rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 my-auto flex flex-col md:flex-row">
              
              {/* Left side: AI & Photo Upload */}
              <div className="w-full md:w-1/3 bg-gray-50 dark:bg-gray-800/50 p-10 border-r border-gray-200 dark:border-gray-800 flex flex-col items-center justify-center text-center">
                <Sparkles className="w-12 h-12 text-purple-500 mb-4" />
                <h3 className="text-xl font-black text-slate-800 mb-2">AI Assessor</h3>
                <p className="text-xs text-gray-500 dark:text-gray-400 mb-8">Upload a photo. Our ML model will auto-classify the damage severity and estimate replacement costs.</p>
                
                {!aiData && !aiLoading && (
                  <button type="button" onClick={simulateAiUpload} className="w-full bg-white dark:bg-gray-900 border-2 border-dashed border-purple-200 text-purple-600 font-bold py-10 rounded-3xl hover:bg-purple-50 transition-colors flex flex-col items-center gap-2">
                ...
                {aiData && (
                  <div className="w-full bg-purple-50 border border-purple-100 p-6 rounded-3xl text-left space-y-4">
                    ...
                    <div>
                      <div className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Detected Severity</div>
                      <div className="text-lg font-black text-slate-800">{aiData.severity}</div>
                    </div>
                    <div>
                      <div className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Est. Replacement Cost</div>
              ...
              <div className="w-full md:w-2/3 flex flex-col">
                <div className="px-10 py-8 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between">
                  <h2 className="text-2xl font-black text-slate-900">Field Report Form</h2>
                  <button onClick={() => setShowModal(false)} className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-50 dark:bg-gray-800/50 text-gray-400 dark:text-gray-500 hover:bg-gray-100 dark:bg-gray-800 transition-all">
                    <X className="w-5 h-5" />
                  </button>
                </div>
                <form onSubmit={handleSubmit} className="p-10 grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6 overflow-y-auto max-h-[60vh]">
                  <div className="space-y-1.5 sm:col-span-2">
                    <label className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest px-1">Location & GPS</label>
                    <div className="flex gap-2">
                      <input name="location" type="text" placeholder="e.g. 42 Main St, Colombo" required className="suraksha-input flex-1" />
                      <button type="button" className="bg-gray-100 dark:bg-gray-800 px-4 rounded-xl text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:bg-gray-700 flex items-center justify-center"><MapPin className="w-5 h-5"/></button>
                    </div>
                  </div>

                  <div className="space-y-1.5">
                    <label className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest px-1">Category</label>
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest px-1">Structural Damage</label>
                    <div className="relative">
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest px-1">Property Ownership</label>
                    <div className="relative">
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest px-1">Income Bracket</label>
                    <div className="relative">
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest px-1">Vulnerability Score (1-10)</label>
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest px-1">Estimated Loss (LKR)</label>
                  ...
                  <div className="space-y-1.5 sm:col-span-2 pt-4">
                    ...
                    <p className="text-center text-[10px] text-gray-400 dark:text-gray-500 mt-2 font-medium">Submitting will auto-calculate compensation eligibility.</p>
                  </div>
                </form>
              </div>
            </div>

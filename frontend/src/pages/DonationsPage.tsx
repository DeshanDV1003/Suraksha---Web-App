  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold tracking-tight text-slate-900">Donations Management</h1>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex items-center space-x-4">
          ...
          <div>
            <p className="text-sm font-medium text-slate-500">Material Donations</p>
                  ...
                  <tr key={d.id} className="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-right">
                      <select
                        ...
                        className="text-xs rounded-lg border-slate-200 bg-white px-2 py-1 focus:ring-blue-500 focus:border-blue-500"
                      >
